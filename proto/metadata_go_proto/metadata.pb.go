...
type Metadata_Deviations struct {
	...
	Subinterface_0StateUnsupported bool `protobuf:"varint,399,opt,name=subinterface_0_state_unsupported,json=subinterface0StateUnsupported,proto3" json:"subinterface_0_state_unsupported,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf7\xde\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\xc3\xd4\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"#isis_database_overloads_unsupported\x18\xf0\x01 \x01(\bR isisDatabaseOverloadsUnsupported\x12O\n" +
	...
	"\afpga_ft\x18\x8e\x03 \x01(\tR\x06fpgaFt\x12H\n" +
	" subinterface_0_state_unsupported\x18\x8f\x03 \x01(\bR\x1dsubinterface0StateUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
